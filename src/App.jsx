...
function App() {
  ...
  const mapSupabaseRowToProduct = useCallback(
    (product) => {
      ...
      whatsapp: vendedor?.whatsapp || product.whatsapp || '',
      email: vendedor?.email || product.email || '',
      telefone: vendedor?.telefone || product.telefone || '',
      localizacao: vendedor?.localizacao || product.localizacao || '',
